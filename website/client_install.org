...
All cryptographic operations happen locally on your device, ensuring your data never leaves your device in plaintext. The client talks to these servers using the **Verifiable Oblivious Pseudo-Random Function (VOPRF)** protocol (based on [[https://datatracker.ietf.org/doc/rfc9497/][RFC 9497]]), allowing them to help you unlock your data without ever learning your secrets.
